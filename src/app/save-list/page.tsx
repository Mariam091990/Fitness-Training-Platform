        ...
        <div className="container mx-auto mb-10 px-4 ">
            ...
            <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="dropdown dropdown-end relative ">
                    ...
                    <ul
                        tabIndex={0}
                        className="dropdown-content menu z-50 mt-2 w-44 rounded-box border border-gray-800 bg-[#151820] p-2 shadow-xl"
                    >
            ...
            <div className="rounded-2xl  bg-[#151820] border border-gray-800  p-5">
                ...
                {sortedLogs.length > 0 ? (
                    ...
                    <div className="space-y-4">
                        ...
                        {sortedLogs.map((log) => (
                            ...
                            <div
                                key={log.id}
                                className="flex flex-col gap-4 rounded-xl border border-gray-800 p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between"
                            >
